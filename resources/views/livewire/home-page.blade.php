            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach($brands as $brand)
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{$brand->id}}">
                        <a wire:navigate href="{{route('products', ['selected_brand' => [$brand->slug]])}}" class="">
                            <img src="{{url('storage',$brand->image)}}" alt="{{$brand->name}}"
                                 class="object-fill w-full h-64 rounded-t-lg">
                        </a>
                        <div class="p-5 text-center">
                            <a wire:navigate href="{{route('products', ['selected_brand' => [$brand->slug]])}}"
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                @foreach($categories as $category)
                    <a wire:navigate wire:key="{{$category->id}}"
                       ...
                       href="{{route('products', ['selected_category'=>[$category->slug]])}}">
