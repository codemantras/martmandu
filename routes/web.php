...
Route::get('/categories/{category}', CategoriesPage::class)->name('categories.show');

Route::get('/brands', CategoriesPage::class)->name('brands');
Route::get('/brands/{brand}', CategoriesPage::class)->name('brands.show');
